            ...
            <div class="card card-default">
              ...
              <?php } ?>
                <div class="card-body row">
                  ...
                  <div class="form-group col-md-3">
                    <input type="text"  class="form-control form-control-sm" name="state_code" id="state_code" title="state Code"  value="<?php if(isset($state_code)){ echo $state_code; } ?>" placeholder="Sate Code" required>
                  </div>
                  <div class="form-group col-md-6">
                    <input type="text" class="form-control" name="phone_no" id="phone_no" title="Phone No"  value="<?php if(isset($phone_no)){ echo $phone_no; } ?>" placeholder="Phone No" >
                  </div>
                  <div class="form-group col-md-6">
                    <input type="text" class="form-control" name="mobile_no" id="mobile_no" title="Mobile No"  value="<?php if(isset($mobile_no)){ echo $mobile_no; } ?>" placeholder="Mobile No" >
                  </div>
                  <div class="form-group col-md-6">
                    <input type="text" class="form-control" name="gst_no" id="gst_no" title="GST No"  value="<?php if(isset($gst_no)){ echo $gst_no; } ?>" placeholder="GST No" >
                  </div>
                  <div class="form-group col-md-6">
                    <input type="text" class="form-control" name="pan_no" id="pan_no" title="PAN No"  value="<?php if(isset($pan_no)){ echo $pan_no; } ?>" placeholder="PAN No" >
                  </div>
                  <div class="form-group col-md-6">
                    <input type="text" class="form-control" name="vender_code" id="vender_code" title="Vendor Code"  value="<?php if(isset($vender_code)){ echo $vender_code; } ?>" placeholder="Vendor Code" >
                  </div>
                </div>
