...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 30, 2019 at 01:41 PM
...
(1, 'Challan System', 'qwerwqer, asgdfg, cvbcxn', 'Kolhapur', 'Maharashtra', 'Kolhapur', 27, '9876543210', '9988776655', 'demo@mail.com', 'demo.com', '5r67fh', '996633', 'dfgh', 'dfgh', '04-05-2019', '30-11-2019', '', 1, '2019-11-30 11:58:56');
...
--
ALTER TABLE `gst`
  MODIFY `gst_id` int(20) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `party_type`
  MODIFY `party_type_id` int(20) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `state`
  MODIFY `state_id` int(20) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `user_roll`
  MODIFY `roll_id` int(20) NOT NULL AUTO_INCREMENT;
